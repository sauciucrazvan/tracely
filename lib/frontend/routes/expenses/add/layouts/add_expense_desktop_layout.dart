...
class AddExpenseDesktopLayout extends StatefulWidget {
  const AddExpenseDesktopLayout({super.key});

  @override
  State<AddExpenseDesktopLayout> createState() =>
      _AddExpenseDesktopLayoutState();
}

class _AddExpenseDesktopLayoutState extends State<AddExpenseDesktopLayout> {
