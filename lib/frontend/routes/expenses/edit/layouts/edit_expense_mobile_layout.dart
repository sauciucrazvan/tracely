...
class EditExpenseMobileLayout extends StatefulWidget {
  final String id;
  ...
  @override
  State<EditExpenseMobileLayout> createState() =>
      _EditExpenseMobileLayoutState();
}

class _EditExpenseMobileLayoutState extends State<EditExpenseMobileLayout> {
