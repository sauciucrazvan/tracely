...
class AddGoalDesktopLayout extends StatefulWidget {
  const AddGoalDesktopLayout({super.key});

  @override
  State<AddGoalDesktopLayout> createState() => _AddGoalDesktopLayoutState();
}

class _AddGoalDesktopLayoutState extends State<AddGoalDesktopLayout> {
