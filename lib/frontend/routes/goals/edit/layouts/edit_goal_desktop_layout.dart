...
class EditGoalDesktopLayout extends StatefulWidget {
  final String goalID;
  final String goal;
  ...
  @override
  State<EditGoalDesktopLayout> createState() => _EditGoalDesktopLayoutState();
}

class _EditGoalDesktopLayoutState extends State<EditGoalDesktopLayout> {
