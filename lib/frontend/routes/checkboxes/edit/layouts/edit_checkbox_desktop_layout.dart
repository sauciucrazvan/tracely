...
class EditCheckboxDesktopLayout extends StatefulWidget {
  final String categoryID;
  final String checkboxID;
  final String name;
  final String date;

  const EditCheckboxDesktopLayout(
      {super.key,
  ...
  @override
  State<EditCheckboxDesktopLayout> createState() =>
      _EditCheckboxDesktopLayoutState();
}

class _EditCheckboxDesktopLayoutState extends State<EditCheckboxDesktopLayout> {
